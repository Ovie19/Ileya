...
const personalityDescriptions = {
    INTJ: `The Architect (16Personalities)
    ...
    INTP: `The Logician (16Personalities)
    ...
    ENTJ: `The Commander (16Personalities)
    ...
    ENTP: `The Debater (16Personalities)
    ...
    INFJ: `The Advocate (16Personalities)
    ...
    INFP: `The Mediator (16Personalities)
    ...
    ENFJ: `The Protagonist (16Personalities)
    ...
    ENFP: `The Campaigner (16Personalities)
    ...
    ISTJ: `The Defender (16Personalities)
    ...
    ESTJ: `The Executive (16Personalities)
    ...
    ESFJ: `TThe Consul (16Personalities)
    ...
    ISTP: `The Virtuoso (16Personalities)
    ...
    ISFP: `The Adventurer (16Personalities)
    ...
    ESTP: `The Entrepreneur (16Personalities)
    ...
    ESFP: `The Entertainer (16Personalities)
...
for (let questionCount = 0; questionCount < 20; questionCount++) {

    console.log(`A. ${optionA[questionCount]}`);
    console.log(`B. ${optionB[questionCount]}`);

    let response;

    while (true) {
        response = prompt("Enter A or B: ").trim().toUpperCase();
...
for (let index = 0; index < 4; index++) {
    ...
    let responseACount = 0;
    let responseBCount = 0;

    for (let innerIndex = index; innerIndex < questionResponses.length; innerIndex += 4) {

        if (questionResponses[innerIndex] === "A") {
            console.log(`A. ${optionA[innerIndex]}`);
            responseACount++;
        } else {
            console.log(`B. ${optionB[innerIndex]}`);
            responseBCount++;
        }
    }
    ...
    switch (index) {
        case 0:
            personality += responseACount > responseBCount ? "E" : "I";
            break;

        case 1:
            personality += responseACount > responseBCount ? "S" : "N";
            break;

        case 2:
            personality += responseACount > responseBCount ? "T" : "F";
            break;

        case 3:
            personality += responseACount > responseBCount ? "J" : "P";
            break;
    }

    console.log(`Number of A selected: ${responseACount}`);
    console.log(`Number of B selected: ${responseBCount}`);
    console.log();
}

console.log(`Personality: ${personality}\n`);

console.log(personalityDescriptions[personality]);